...
test.describe('User Profile Editing - Fixed', () => {
  ...
  test('User can navigate to settings and edit profile', async ({ page }) => {
    ...
    // Step 5: Submit the form - use more specific selector to avoid Sign out button
  ...
  test('Admin user can also edit profile', async ({ page }) => {
    ...
    // Look for sign out button/link - could be in navigation
    ...
    // Use specific selector for admin profile save button
